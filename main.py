...
bot_token = environ.get("TOKEN", "7797698648:AAHDcMWqqlirBcXPCgUYGK2ak7ky3kPGoqA") 
api_hash = environ.get("HASH", "e5d187c6c7a0919ccb8866f76f655701") 
api_id = int(environ.get("ID", "26512964"))
